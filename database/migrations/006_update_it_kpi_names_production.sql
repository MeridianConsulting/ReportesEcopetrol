-- =====================================================
-- Migración 006: Actualizar nombres de KPIs de IT (PRODUCCIÓN)
-- Fecha: 2026-01-26
-- Descripción: Actualiza los nombres de los KPIs de IT según nueva nomenclatura
--              Este script es seguro para ejecutar en producción y es idempotente
-- =====================================================
...
-- =====================================================
-- Descomentar para verificar antes de ejecutar:
...
-- IT_05: Eficiencia en Atención y Cierre de Soporte IT
-- Actualiza tanto "Atención y Cierre de Incidentes" como "Atención y Cierre de Incidentes de Soporte"
UPDATE `kpi_categories` kc
INNER JOIN `kpis` k ON kc.kpi_id = k.id
...
-- 2. Las tareas existentes NO se ven afectadas directamente porque solo tienen 
--    referencias por ID (kpi_category_id), no por nombre
-- 3. Los nombres se actualizarán automáticamente en la interfaz cuando se carguen
--    desde la base de datos
-- 4. Los cálculos de KPIs (task_kpi_facts) NO se ven afectados porque usan kpi_id
-- 5. Se recomienda hacer un backup antes de ejecutar en producción
-- =====================================================
...
--     -> 'Continuidad Operativa de Servicios Críticos (Disponibilidad)'
--
-- IT_02: 'Cumplimiento de Mantenimiento de Infraestructura' 
--     -> 'Cumplimiento del Plan de Mantenimiento Tecnológico (Infraestructura)'
--
-- IT_03: 'Cumplimiento en Desarrollo y Automatización' 
--     -> 'Entrega de Desarrollo y Automatización (Software)'
--
-- IT_04: 'Actualización de Documentación Técnica' 
--     -> 'Actualización de Documentación y Control de Activos IT'
--
-- IT_05: 'Atención y Cierre de Incidentes de Soporte' 
--     -> 'Eficiencia en Atención y Cierre de Soporte IT'
-- =====================================================
