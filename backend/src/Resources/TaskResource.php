...
class TaskResource
{
  public static function toArray(array $task): array
  {
    ...
    return [
      ...
      'area_destinataria_id' => isset($task['area_destinataria_id']) && $task['area_destinataria_id'] !== '' ? (int)$task['area_destinataria_id'] : null,
      'area_destinataria_name' => $task['area_destinataria_name'] ?? null,
      'title' => $task['title'] ?? '',
